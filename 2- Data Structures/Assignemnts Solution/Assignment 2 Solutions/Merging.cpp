// This problem simulates merging tables in a certain database
// Time Complexity: O(mlog*n)
// Where: (m) is the number of calling Merge operation and (n) is the number of tables in the database
#include<bits/stdc++.h>
